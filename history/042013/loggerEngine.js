...
//			if (json[x].duration> maxTime){
//				maxTime = parseFloat(json[x].duration);
//			}
//		}
//	}
		...
		/** Draw **/
//		drawVisualization(titles[j], id, array[j], {height:height, width:width, maxTime: maxTime, legend:true, scale:'1,1'});
//	}
...
//	column.setAttribute("id",  id + "_avg");
//	row.appendChild(column);
//	
//	column = document.createElement("th");
